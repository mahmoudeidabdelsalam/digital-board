...
export const portfolio = [
  ...
  {
    title: 'دعوة زفاف فريدة',
    category: 'Website',
    description: 'نحن نؤمن بأن كل لحظة في حياة الإنسان تستحق أن تُخلّد، وأن كل مناسبة تستحق أن تُحتفل بها. لذلك، نقدم لك بطاقة دعوة زفاف فريدة من نوعها، تجمع بين الأناقة والابتكار، لتكون بداية رحلة حياتك الجديدة.',
    image: './portfolio-10.webp',
    link: 'https://wedding-invite-card.pages.dev/',
  },
  {
    title: 'موقع زفاف فريدة',
    category: 'Website',
    description: 'نحن نؤمن بأن كل لحظة في حياة الإنسان تستحق أن تُخلّد، وأن كل مناسبة تستحق أن تُحتفل بها. لذلك، نقدم لك بطاقة دعوة زفاف فريدة من نوعها، تجمع بين الأناقة والابتكار، لتكون بداية رحلة حياتك الجديدة.',
    image: './portfolio-11.webp',
    link: 'https://wedding-invite-9gy.pages.dev/',
  }
];
